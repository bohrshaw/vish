...
nmap     <buffer><silent>RB <SID>(update):GoBuild<CR>
nmap     <buffer>Ri         <SID>(update)<Plug>(go-install)
...
nnoremap <buffer>gQ                      :GoFmt<CR>
nnoremap <buffer><LocalLeader>i          :GoImport
nnoremap <buffer><silent><LocalLeader>gi :GoImports<CR>
nmap     <buffer><LocalLeader>k          <Plug>(go-info)
...
xnoremap <buffer><LocalLeader><silent>f  :GoFreevars<CR>
